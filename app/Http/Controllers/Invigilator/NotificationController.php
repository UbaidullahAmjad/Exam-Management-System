...
class NotificationController extends Controller
{
    public function index(){
        ...
        return view('invigilator.notifications.index',[
            'notifications' => $notifications
        ]);
    }

    public function create(){
        return view('invigilator.notifications.create');
    }
    ...
    public function store(Request $request){
        ...
        return redirect()->route('invigilator.notification.index')->with('success','Notification has been created');
    ...
    public function edit($id){
        ...
        return view('invigilator.notifications.edit',[
    ...
    public function update(Request $request,$id){
        ...
        if($request->notification_group == "All"){
            ...
            if(!empty($cand_array)){
                ...
                return redirect()->route('invigilator.notification.create')->with('success','Please select atleast one checkbox if click on selected group');
            }
        ...
        return redirect()->route('invigilator.notification.index')->with('success','Notification has been updated');
    ...
    public function destroy($id){
        ...
        return redirect()->route('invigilator.notification.index')->with('success','Notification has been deleted');
    }
}
