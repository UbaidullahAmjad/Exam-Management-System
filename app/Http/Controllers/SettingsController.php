...
class SettingsController extends Controller
{
    ...
    public function writeEmail(){
        return view('settings.emailsend');
    }
    ...
    public function sendEmail(Request $request){
            ...
            if($request->email_group == "1"){
                ...
                return redirect()->route('setting.writeemail')->with('success','Email send to all candidates');
                ...
                if(!empty($cand_array)){
                    ...
                    return redirect()->route('setting.writeemail')->with('success','Email send to selected candidates');
                }else{
                    return redirect()->route('setting.writeemail')->with('success','Please select atleast one checkbox if click on selected group');
                }
            }
    ...
    public function candidateActivity(){
        ...
        return view('settings.candidateactivity',[
...
// dd($account_setting);
        return view('settings.payment_account_settings',[
