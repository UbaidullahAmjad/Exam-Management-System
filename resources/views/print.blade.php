    ...
    <head>
        ...
        <style>
            .green p{
                ...
                background-image: url(/EMS/public/images/tick.jpg);
            ...
            .red p{
                ...
                background-image: url(/EMS/public/images/cross.png);
                background-repeat: no-repeat;
                background-size: 21px 21px;
                background-position: right;
                padding: 8px;
            ...
            <form id="MyForm" name="MyForm" action="#">
                ...
                <div class="container">
                    ...
                    <div id="basicwizard" class="pt-0">
                                <div class="row">
                                    <div class="col-12">
                                        <a href="{{ route('invigilatorprintexam',[$exam->id,$candidate->id]) }}" class="btn btn-info float-right mt-5">Print Result</a>
                                    </div>
                                </div>
                                ...
                                <div class="card-body mt-3 b-0 mb-0">
                                    <?php if($i <= count($questions)){?>
                                        <!-- <div class="tab-pane m-t-10 fade card p-5 tab-class" name="tab_name" id="tab<?php echo $i; ?>" > -->
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <p><b>Question {{$i}} of {{ count($questions) }}</b></p>
                                                    <div>
                                                    ...
                                                    <?php if($selected->answer == $correct->correct_answer && $selected->answer == $question_option->option){?>
                                                    ...
                                                    <?php }else{
                                                        ...
                                                        <?php }elseif($question_option->option != $correct->correct_answer){?>

                                                            <span style="background-color: red !important;">{!! html_entity_decode($question_option->option) !!}</span>
                                                        <?php }
                                                            }?>
...
//   if (e.key == "Enter")  window.location.href ="/";
            if (e.key == "Escape") window.location.href ="{{ route('invigilator.dashboard') }}";
            });
