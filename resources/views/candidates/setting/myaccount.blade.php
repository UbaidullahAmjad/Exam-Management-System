        ...
        <div class="row container">
							...
							<div class="col-xl-12">
								<div class="card m-b-20">
                                    ...
                                    @endif
                                    <div class="card-body">
										<form action="{{ route('candidate.updateaccount') }}" enctype="multipart/form-data" method="POST">
											@csrf
														...
														<div class="row">
															...
															<div class="col-md-6">
                                                                <div>
                                                                    ...
                                                                    <input type="email" id="username" name="username" value="{{ $candidate_info->username }}" class="form-control" readonly><br>
                                                                </div>
                                                                <div>
                                                                ...
                                                                <div>
                                                                    <label for="exam_date" class="mt-5">Exam Date</label>
                                                                    <input type="date" class="form-control"  value="{{ $candidate_info->request_date}}" format="Y-m-d" name="request_date" id="request_date"><br>
                                                                </div>
														...
														<div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <textarea type="text" name="experince" value="{{ $candidate_info->experience }}" id="experince" class="form-control">{{ $candidate_info->experience }}</textarea><br>
                                                                </div>
                                                            </div>
														</div>
                                                        <div class="row mb-5">
                                                            <div class="col-12">
                                                                ...
                                                                <textarea type="text" name="address" value="{{ $candidate_info->address }}" id="address" class="form-control">{{ $candidate_info->address }}</textarea><br>
                                                            </div>
                                                        </div>
                                                        <ul class="list-inline wizard mb-0">
														<li class="previous list-inline-item"><a href="#" class="btn btn-info mb-0 waves-effect waves-light">Previous</a>
													...
													<div class="tab-pane m-t-10 fade" id="tab3">
                                                        <table class="table">
                                                                <tr>
                                                                    ...
                                                                    <td><input type="radio" name="approvedbyauth" onclick="approvedByAuth(<?php echo $candidate_info->candidate_id; ?>)" id="yes"> <span>Yes</span>
                                                                    <input type="radio"name="approvedbyauth" onclick="approvedByAuth(<?php echo $candidate_info->candidate_id; ?>)" id="no"> <span>No</span></td>
                                                                </tr>
                                                            </table>
														<div class="row" id="non-auth" style="display: none;">
                                                            <h3>For non-registered applicants: In order to be eleigible to schedule your AUTH Approval, you must:</h3>
                                                            <h5>1. Fill and submit the registration form with AUTH here <a href="//www.auth.com/registration.com">www.auth.com/registration.com</a></h5>
                                                            <h5>2. Login to the AUTH system using credentials that you have received by email from AUTH;</h5><br>
                                                            <h5>3. Click the "Apply for personnel certification" button; and</h5><br>
                                                            <h5>4. Fill in the personnel certification service request form and submit it.</h5>
                                                        ...
                                                        <div class="row" id="auth" style="display: none;">
                                                            <div class="col-md-6">
                                                                @if($cand_info->auth_approval_id != NULL)
                                                                <div>
                                                                    <label for="approval_id">Approval ID</label>
                                                                    <input type="text" id="approval_id" value="" name="approval_id" class="form control">
                                                                </div>
                                                                @else
                                                                <div>
                                                                    <label for="approval_id">Approval ID</label>
