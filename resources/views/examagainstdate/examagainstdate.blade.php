                    ...
                    <table class="table">
                        ...
                        @if(count($data) > 0)
                            ...
                            <tr>
                                ...
                                <td>{{$exam->name }}</td>
                                <td>{{ $request_date }}</td>
                                <td>{{ $d->exam_take_status }}</td>
                                @if($d->exam_take_status == "Taken")
                                ...
                                <td>N/A</td>
                                @endif
                                <td><a href="{{ route('viewcandidateexam',[$exam->id,$candidate->id]) }}" class="btn btn-info"><i class="fa fa-eye"></i></a></td>
                            </tr>
                            @endforeach
                        @else
                        <p class="text-center" style="color: red;">No Exam Found against {{ $request_date }}</p>
                        @endif
