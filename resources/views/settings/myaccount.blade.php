									...
									<div class="card-body">
											...
											<div id="basicwizard" class="border pt-0">
                                                ...
                                                <li class="nav-item"><a href="#tab1" data-toggle="tab" class="nav-link font-bold"><i class="fa fa-globe"></i> General Information</a></li>
													...
													<li class="nav-item"><a href="#tab2" data-toggle="tab" class="nav-link font-bold"><i class="fa fa-phone"></i> Contact Information</a></li>
												</ul>
															...
															<div class="col-12">
																<div class="form-group clearfix">
																	...
																	<div class="row ">
																		...
																		<div class="col-md-9">
																			<input class="form-control required" id="organization" value="{{ $details->organization_name }}" name="organization" type="text" required>
																		</div>
																	</div>
																</div>
																<div class="form-group  clearfix">
																	<div class="row ">
																		...
																		<div class="col-md-9">
                                                                            <select class="form-control" name="time_zone" id="time_zone">
                                                                                <option value="{{ $details->time_zone }}" selected>{{ $details->time_zone }}</option>
																...
																<div class="form-group clearfix">
																	<div class="row ">
																		...
																		<div class="col-md-9">
																		    ...
																		    @if($details->daylight == "on")
																			<input id="daylight" name="daylight" type="checkbox" class="" checked>
																			@else
																			<input id="daylight" name="daylight" type="checkbox" class="">
																			@endif
																		</div>
																	</div>
                                                                </div>
																	...
																	<div class="row ">
																		...
																		<div class="col-md-9">
                                                                            <label class="control-label form-label" for="logo">
                                                                                <img src="{{ asset('/storage/'. $details->logo) }}" width="150" height="150">
                                                                            </label>
