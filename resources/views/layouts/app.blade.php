 ...
 <link href="https://cdn.jsdelivr.net/npm/froala-editor@3.1.0/css/froala_editor.pkgd.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100">
            ...
            <?php $detail = App\Models\CompanyDetail::where('admin_id',auth()->user()->id)->first(); ?>
            <!-- Page Heading -->
            <header class="bg-white shadow">
				...
				<aside class="app-sidebar doc-sidebar">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="{{ route('exam.index') }}"><i class="side-menu__icon fa fa-paste"></i><span class="side-menu__label"> Exam</span></a>
                        ...
                        <li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="{{ route('candidate.index') }}"><i class="side-menu__icon fa fa-user"></i><span class="side-menu__label">Candidates</span></a>
                        </li>
                        <li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="{{ route('question.index') }}"><i class="side-menu__icon fa fa-question-circle"></i><span class="side-menu__label">Questions</span></a>
                        </li>
                        <li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="{{ route('notification.index') }}"><i class="side-menu__icon fa fa-bell"></i><span class="side-menu__label">Notifications</span></a>
                        </li>
                        <li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="{{ route('setting.index') }}"><i class="side-menu__icon fe fe-settings"></i><span class="side-menu__label">Settings</span></a>
						</li>
						<!-- <li class="slide">
    ...
    <script src="{{ asset('/assets/js/jquery-3.2.1.min.js')}}"></script>
		...
		<script>
						...
						CKEDITOR.replace( 'editor2', {
							filebrowserUploadUrl: "{{ route('question.uploada', ['_token' => csrf_token() ]) }}",
							filebrowserUploadMethod: 'form'
						});

						CKEDITOR.replace( 'editor3', {
							filebrowserUploadUrl: "{{ route('question.uploadb', ['_token' => csrf_token() ]) }}",
							filebrowserUploadMethod: 'form'
						});

						CKEDITOR.replace( 'editor4', {
							filebrowserUploadUrl: "{{ route('question.uploadc', ['_token' => csrf_token() ]) }}",
							filebrowserUploadMethod: 'form'
						});

						CKEDITOR.replace( 'editor5', {
							filebrowserUploadUrl: "{{ route('question.uploadd', ['_token' => csrf_token() ]) }}",
							filebrowserUploadMethod: 'form'
						});

						CKEDITOR.replace( 'editor6', {
							filebrowserUploadUrl: "{{ route('question.uploade', ['_token' => csrf_token() ]) }}",
							filebrowserUploadMethod: 'form'
						});
