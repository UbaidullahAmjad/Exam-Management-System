...
<?php $cand_info = App\Models\CandidateInformation::where('candidate_id',auth()->user()->id)->first(); ?>
            <!-- Page Heading -->
            <header class="bg-white shadow">
				...
				<div class="app-header1 header py-1 d-flex">
					<div class="container-fluid">
						<div class="d-flex">
							<a class="header-brand" href="/projects/EMS/public/candidate/exam">
								<h3 class="logo-name"><img src="{{ asset('/assets/images/logo.png') }}" style="background-color: white; border-radius:10px" alt="" height="80" width="100"></h3>
							...
							<div class="d-flex order-lg-2 ml-auto">
								...
								<div class="dropdown ">
									<a href="#" class="nav-link pr-0 leading-none user-img" data-toggle="dropdown">
										<img src="{{ asset('/storage/'. $user->avatar) }}" class="avatar avatar-md brround">
									</a>
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow ">
				...
				<aside class="app-sidebar doc-sidebar">
					<div class="app-sidebar__user clearfix">
						<div class="dropdown user-pro-body">
							<div>
								<img src="{{ asset('/storage/'. $user->avatar) }}" alt="user-img" class="avatar avatar-lg brround">
								<!--<a href="#" class="profile-img">-->
								<!--	<span class="fa fa-pencil" aria-hidden="true"></span>-->
								<!--</a>-->
							</div>
							<div class="user-info">
								<h2>{{ auth()->user()->name }} (Candidate)</h2>
					...
					<ul class="side-menu">
						<li class="slide">
							<!-- <a class="side-menu__item" data-toggle="slide" href="{{ route('dashboard.index') }}"><i class="side-menu__icon fe fe-airplay"></i><span class="side-menu__label">Dashboard</span></a> -->
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="{{ route('candidate.exam.index') }}"><i class="side-menu__icon fa fa-paste"></i><span class="side-menu__label"> Exam</span></a>
                        ...
                        <li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="{{ route('candidate.exam.history') }}"><i class="side-menu__icon fa fa-user"></i><span class="side-menu__label">Exam History</span></a>
                        </li>

                        <li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="{{ route('candidate.notification.index') }}"><i class="side-menu__icon fa fa-bell"></i><span class="side-menu__label">Notifications</span></a>
                        </li>
						@endif
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="{{ route('candidate.account') }}"><i class="side-menu__icon fa fa-user"></i><span class="side-menu__label">My Account</span></a>
                        </li>
						@if($cand_info->status == "Approved")
						<li class="slide">
							<!-- <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fa fa-question-circle"></i><span class="side-menu__label">Help</span></a> -->
                        </li>

                        <li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="{{ route('user.logout') }}"><i class="side-menu__icon fe fe-settings"></i><span class="side-menu__label">Logout</span></a>
						</li>
						@endif
						<!-- <li class="slide">
